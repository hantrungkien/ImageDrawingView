...
import static com.kienht.imagedrawing.sticker.TextSticker.TIME_SHOW_CURSOR;
...
public class StickerView extends FrameLayout {
    ...
    private final List<BitmapStickerIcon> icons = new ArrayList<>(2);
    ...
    protected void drawStickers(Canvas canvas) {
        ...
        if (handlingSticker != null && handlingSticker instanceof TextSticker && !locked) {
            ...
            postInvalidateDelayed(TIME_SHOW_CURSOR);
        }
